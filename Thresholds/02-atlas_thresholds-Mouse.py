...
# DATA SETUP
datasets_by_tissue = "/lustre/scratch127/cellgen/cellgeni/projects/cellxgene_census_snapshot/Mus_musculus/2024-08-05/datasets_by_tissue/"
#output_directory = "/nfs/team292/eg22/Metabolic-Tasks/CELLxGENE/Thresholds-Calculation-Mouse/"
output_directory = "/lustre/scratch126/cellgen/team292/eg22/Thresholds-Calculation-Mouse/"
sccellfie_data_folder = '/nfs/team292/eg22/Metabolic-Tasks/Task-Data/mus_musculus/'

ensembl2symbol = pd.read_csv(os.path.join(sccellfie_data_folder, 'Ensembl2symbol_mouse.csv'))
